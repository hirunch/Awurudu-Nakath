...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView n1Countdown1;
    private TextView n1Countdown2;
    private TextView n1Countdown3;
    private TextView n1Countdown4;
    private TextView n1Countdown5;
    private TextView n1Countdown6;
    ...
    private String nakathThree = "2024-04-14 06:17:00";
    private String nakathFour = "2024-04-14 07:07:00";
    private String nakathFive = "2024-04-15 10:23:00";
    private String nakathSix = "2024-04-17 06:54:00";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n1Countdown1 = findViewById(R.id.text);
        n1Countdown2 = findViewById(R.id.text2);
        n1Countdown3 = findViewById(R.id.text3);
        n1Countdown4 = findViewById(R.id.text4);
        n1Countdown5 = findViewById(R.id.text5);
        n1Countdown6 = findViewById(R.id.text6);
...
//
    ...
    private void startCountdown1(long millisInFuture) {
        countDownTimer1 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                n1Countdown1.setText(countdownText);
            }

            @Override
            public void onFinish() {
                n1Countdown1.setText("සුභ අලුත් අවුරුද්දක් වේවා!");
            }
        }.start();
    }
    ...
    private void startCountdown2(long millisInFuture) {
        countDownTimer2 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                String countdownText = getCountdownText(millisUntilFinished);
                n1Countdown2.setText(countdownText);
            }

            @Override
            public void onFinish() {
                n1Countdown2.setText("");
    ...
    private void startCountdown3(long millisInFuture){
        ...
        countDownTimer3 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                String countdownText = getCountdownText(millisUntilFinished);
                n1Countdown3.setText(countdownText);
            }

            @Override
            public void onFinish() {
                n1Countdown3.setText("");
    ...
    private void startCountdown4(long millisInFuture) {
        countDownTimer4 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                String countdownText = getCountdownText(millisUntilFinished);
                n1Countdown4.setText(countdownText);
            }

            @Override
            public void onFinish() {

                n1Countdown4.setText("");
            }
        }.start();
    }
    ...
    private void startCountdown5(long millisInFuture) {
        countDownTimer5 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                String countdownText = getCountdownText(millisUntilFinished);
                n1Countdown5.setText(countdownText);
            }

            @Override
            public void onFinish() {

                n1Countdown5.setText("");
            }
        }.start();
    }
    ...
    private void startCountdown6(long millisInFuture) {
        countDownTimer6 = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                String countdownText = getCountdownText(millisUntilFinished);
                n1Countdown6.setText(countdownText);
            }

            @Override
            public void onFinish() {

                n1Countdown6.setText("");
            }
        }.start();
    }
